...
function_url="https://311-analyse-function.azurewebsites.net/api/HttpTrigger1?code=FvTiSRlZGyyxka_CVvaOANXslOPMJVrLhT-CgiI7A9U2AzFufFEGTQ=="

# Replace with your Azure Function App key or any other authentication mechanism
api_key="FvTiSRlZGyyxka_CVvaOANXslOPMJVrLhT-CgiI7A9U2AzFufFEGTQ=="  ###"function-app-key"
set -x

...
function_url="https://311-wf-transcribe-function.azurewebsites.net/api/HttpTrigger1?code=-NXZSlt2nNU169g0HTiZlG29saG2n9XWO_ceMIMDVRQSAzFuzXXQeQ=="

# Replace with your Azure Function App key or any other authentication mechanism
api_key="-NXZSlt2nNU169g0HTiZlG29saG2n9XWO_ceMIMDVRQSAzFuzXXQeQ=="  ###"function-app-key"
set -x

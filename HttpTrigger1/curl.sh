...
function_url="https://311-redart-function.azurewebsites.net/api/HttpTrigger1?code=z2_bHUDcFwxCaOw_iKml-CoPuMjnZhnADtoedWl-8T1UAzFubN3Kqw=="

# Replace with your Azure Function App key or any other authentication mechanism
api_key="z2_bHUDcFwxCaOw_iKml-CoPuMjnZhnADtoedWl-8T1UAzFubN3Kqw=="  ###"your-api-key"
set -x
